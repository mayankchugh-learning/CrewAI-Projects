...
class YoutubeAutomationAgents():
    ...
    def linkedIn_post_creator(self):
        return Agent(
            role="LinkedIn Post Creator",
            goal="""Create an LinkedIn Post to the marketing team to promote the new YouTube video.""",
            role="LinkedIn Post Creator",
            backstory="""As an LinkedIn Post Creator, you are responsible for creating an linkedin post to send to the marketing team 
                to promote the new YouTube video.
                
                It is vital that you ONLY ask for human feedback after you've created the linkedin post.
                Do NOT ask the human to create the linkedin post for you.
                """,
            verbose=True,
            tools=human_tools
        )