...
class YoutubeAutomationTasks():
    ...
    def create_linkedin_post_for_new_video(self, agent, video_topic, video_details):
        return Task(
            description=dedent(f"""Create an linkedin post to send to promote the new YouTube video.
                ...
                Important Notes:
                - Make sure to copy my style, tone, and voice when writing the linkedin post.
                - Create a draft email. Once you have created a draft linkedin post, you MUST have a human review your tenative final linkedin post.

                Linkedin Post 1:
                ----------------
                Title: New CrewAI Tutorial: Learn How To Use the Latest CrewAI Features
                ...
                Email 2:
                ----------------
                Title: New CrewAI + Ollama Tutorial: Learn How To Run CrewAI for Free
            ...
            agent=agent,
            expected_output=dedent(f"""
                An linkedin post that contains a title and body that is formatted exactly like the example linedin post provided to you earlier.
            """)
        )
