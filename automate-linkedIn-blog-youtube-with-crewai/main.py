...
linkedIn_post_creator = agents.linkedIn_post_creator()
...
create_linkedin_post_for_new_video = tasks.create_linkedin_post_for_new_video(
    agent=email_creator,
    video_topic=video_topic,
    video_details=video_details
)
...
crew = Crew(
    ...
    tasks=[manage_youtube_video_creation,
           ...
           create_linkedin_post_for_new_video],
