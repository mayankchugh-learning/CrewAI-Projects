...
class AutomationTasks():
    ...
    def manage_youtube_video_creation(self, agent, topic, details):
        return Task(
    ...
    def manage_youtube_video_research(self, agent, topic, details):
        return Task(
    ...
    def create_youtube_video_title(self, agent, topic, details):
        return Task(
    ...
    def create_youtube_video_description(self, agent, topic, details):
        return Task(
